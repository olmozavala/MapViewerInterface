    ...
    <div id="CalendarsAndStopContainer">
        <table id="CalendarParent" border="0">
            ...
            <tr>
                ...
                <td><span id="hideOneDayEnd" class="calTitle ie_shadow" style="padding-right:0px;">End date </span>
					<span class="closeButton" onclick="hideCalendarFunc();" style="position:absolute;right:5px;top:5px;">x</span>
				</td>
            </tr>
            <tr>
