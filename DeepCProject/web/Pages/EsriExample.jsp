...
<script type="text/javascript"  >
	...
	function init(){
		...
		var resolutions = [ 78271.5169639999,39135.7584820001,19567.8792409999,9783.93962049996,4891.96981024998,2445.98490512499,1222.99245256249,611.49622628138,305.748113140558,152.874056570411];

		var options = { controls: [],maxExtent: bounds, resolutions: resolutions, projection: new OpenLayers.Projection('EPSG:4326'),units: 'm'};
...
/*
	layer0 = new OpenLayers.Layer.ArcGIS93Rest("ESRI Satellite",
		 ...
		 //"http://services.arcgisonline.com/ArcGIS/rest/services/Specialty/DeLorme_World_Base_Map/MapServer/export",
...
//			projection: 'EPSG:4326',
	...
	layer0 = new OpenLayers.Layer.ArcGISCache( "World Imagery Map",
	...
	layer1 = new OpenLayers.Layer.WMS('2010 Temperature','http://viewer.coaps.fsu.edu/ncWMS/wms', 
	{height: 512,width: 512,layers: 'hycom2010/temperature',styles: '',srs: 'EPSG:4326',transparent: true,
		resolutions: resolutions,
		format_options: '',format: 'image/gif',tiled: true,tilesOrigin: '-98.0,18.09164810180664'},
					...
					<!--					If the layer is a netcdf file then we show the optional and default palettes-->
						...
						<tr><td>
								<table border="0" class="palette" align="center">
									<tr>
										<td> <img id="imgPalette" src="http://viewer.coaps.fsu.edu/ncWMS/wms?REQUEST=GetLegendGraphic&LAYER=hycom2010/temperature&COLORBARONLY=true&PALETTE=rainbow&WIDTH=20&HEIGHT=100&NUMCOLORBANDS=254"/></td>
										<td class="waitBack">
											<p class="palMinMax">
												&nbsp; 
