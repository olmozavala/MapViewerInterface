<%-- 
    ...
    Author     : olmozavala
--%>
<table id="helpInstructions" border="0" cellpadding="5" cellmargin="7" align="center">
    <tr><td colspan="2" height="30" class="helpTitle" valign="top" style="text-align: center;"><font color="black">Map Instructions</font><span type="button" class="small awesome" style="float:right" onclick="hideHelp()">x</span></td></tr>
    <tr><td width="210"><img src="${basepath}/common/images/icon/mouse_cursor.png">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="${basepath}/common/images/icon/keyboard_keys.gif"></td><td><b>Move map:</b><BR/> - Click the map with the mouse, while holding the mouse button and drag around the map. <BR/> - You can also use your keyboard arrows to move the map.</td></tr>
    <tr><td>
            <table>
                <tr><td>
            <img src="${basepath}/common/JS/openlayers/img/zoom-plus-mini.png" style="padding-left:10px;">
                <br><br>

                <img src="${basepath}/common/JS/openlayers/img/zoom-minus-mini.png" style="padding-left:10px;">
                    </td>
                    <td>
                        
                        <img src="${basepath}/common/images/icon/mouse_wheel.jpg" style="padding-left:60px;">
    ...
    <tr><td style="text-align:center;">      <img id="imgPalette" src="${paletteUrl}" /> </td><td><b>Change color palette:</b><BR/>If you click on this icon it will pop a menu from which you can change the colors.</td></tr>
            ...
            <table border="0" class="palette" align="center">
                <tr>
                    ...
                    <td class="waitBack">
                        <p class="palMinMax">
                            &nbsp; 
                            max: <input id="maxPal" type="text" size="2" /> 
                            &nbsp;
                        </p>
                        <br><p class="small awesome" style="font-size:11px;" >
                            Update 
                        </p>
                        ...
                        <p class="palMinMax">
                            &nbsp;
                            min: <input  id="minPal"  type="text" size="2" />
                            &nbsp;
                        </p>
                    </td>
                </tr>
            </table></td><td><b>Change color range:</b><BR/>You can also choose a range of maximum and minimum values for the temperature, this will change the color ranges allowed in the map. The minimum temperature must always be lower than the maximum value. One a desired number is chosen click the update button to see the changes in the map. </td></tr>
    
    <tr><td style="text-align:center;"><span class="small awesome">
   ...
   <tr><td><table class="vectorLayer">
                <c:forEach var="vectorLayer" items="${vectorLayers.childs}" varStatus="indice">
                    <tr> 
                        <td>
                            <input id="checkBox${indice.count}" type="checkbox" /> 
                            ${menuHelper:transName(vectorLayer,language)}                     </td>
                        <td align="RIGHT">
    ...
    <tr><td style="text-align:center;"><span class="small awesome">Resize window</span></td><td><b>Resize window:</b><BR/>- If you need to adjust the map size to your current window size.</td></tr>
    <tr><td style="text-align:center;"><span class="small awesome">Email</span> </td><td><b>Contact us:</b><BR/>-If you have any questions or want to report a bug.</td></tr>
  <tr><td style="text-align:center;"><span class="small awesome">Help</span></td><td><b>Help menu:</b><BR/>- Display Instructions</td></tr>
  <tr><td style="text-align:center;"><span class="small awesome">Display Animation</span></td><td><b>Animations:</b><BR/>- Choose a beginning date in the calendar as a starting date. Depending if the dataset is weekly, monthly, or yearly the end calendar will change accordingly to the maximum time range allowed. 
    ...
    <tr><td style="text-align:center;"><span class="small awesome">Stop animation</span></td><td><b>Stop animation:</b><BR/>-This button will disable the animation.</td></tr>
    <tr><td style="text-align:center;"><span class="small awesome">Hide Calendar</span></td><td><b>Hide Calendar:</b><BR/>-Toggle between this option to show/hide the calendar.</td></tr>
</table>    
