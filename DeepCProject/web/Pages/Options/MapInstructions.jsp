    ...
    <tr>
        <td id="helpInstructions" >
            <table border="0" cellpadding="5" cellmargin="7" align="center" id="align_left">
                ...
                <tr><td width="210" style="text-align:center;"><img src="${basepath}/common/images/icon/mouse_cursor.png">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="${basepath}/common/images/icon/keyboard_keys.png"></td><td><b>Move map:</b><BR/> - Click the map with the mouse, while holding the mouse button and drag around the map. <BR/> - You can also use your keyboard arrows to move the map.</td></tr>
