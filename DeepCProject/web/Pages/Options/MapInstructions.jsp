...
<table>
    ...
    <tr><td colspan="2" height="0" class="helpTitle" valign="top" style="text-align: center;"><font color="black">Map Instructions</font><span type="button" class="small awesome " style="float:right" onclick="hideHelp()">x</span></td></tr>
    ...
    <tr><td style="text-align:center;">
        ...
        </td><td><b>Zoom map:</b><BR/>- Use <img src="${basepath}/common/JS/openlayers/img/zoom-plus-mini.png" > and <img src="${basepath}/common/JS/openlayers/img/zoom-minus-mini.png" > buttons located at the top left to zoom.<BR/>- Use mouse wheel to zoom in and out.</td></tr>
            ...
            <table border="0" class="palette" align="center">
                <tr>
                    ...
                    <td class="waitBack">
                        <p class="palMinMax">
                            &nbsp; 
                            max: <input id="maxPal" type="text" size="2" disabled="disabled" /> 
                            &nbsp;
                        </p>
                        <br><p class="small awesome no_hover" style="font-size:11px; cursor:default; " >
                            Update 
                        </p>
                        ...
                        <p class="palMinMax">
                            &nbsp;
                            min: <input  id="minPal"  type="text" size="2"  disabled="disabled"/>
                            &nbsp;
                        </p>
                    </td>
                </tr>
